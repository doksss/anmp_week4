...
class ListHandphoneViewModel(application: Application): AndroidViewModel(application) {
    val handphonesLD = MutableLiveData<ArrayList<Handphone>>() //live data yang berjenis ArrayListofStudent
...
//        )
        ...
        val url = "http://172.20.10.2/handphone/handphone.json"
        ...
        val stringRequest = StringRequest(
            ...
            {//callback function jika volly success dibaca
                ...
                handphonesLD.value = result as ArrayList<Handphone>
            },
            {
                loadingLD.value = false
